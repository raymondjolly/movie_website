...
#movies variable stores the attributes above where they are called in the fresh_tomatoes.py file.
movies=[gran_torino,stripes, fury, the_jerk, star_wars, inside_out]

#this file calls the open_movies_page in the fresh_tomatoes.py file so that the page may be automatically populated.
